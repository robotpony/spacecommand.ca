...
class DecorationV2 extends UIComponent {
  constructor(options = {}) {
    super(options);
...
class TitleScreenV2 extends UIComponent {
  constructor(options = {}) {
    super(options);
    ...
    this.logoComponent = new DecorationV2({
      type: 'logo',
...
module.exports = { DecorationV2, TitleScreenV2 };